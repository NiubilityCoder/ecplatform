...
?>
            <dd><a href="<?php echo $this->_var['subitem']['url']; ?>" class="<?php if ($this->_var['subitem']['name'] == $this->_var['_curitem']): ?>active<?php else: ?>normal<?php endif; ?>"><span class="<?php echo $this->_var['subitem']['icon']; ?>"><?php echo $this->_var['subitem']['text']; ?></span></a></dd>
